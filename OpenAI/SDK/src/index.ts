...
import { OpenAIEditAPI } from './apis/edits.api';
...
import { OpenAIEngineAPI } from './apis/engines.api';
...
const openAIEditAPI = new OpenAIEditAPI(openaiInstance);
...
const openAIEngineAPI = new OpenAIEngineAPI(openaiInstance);
...
const main = async () => {
  ...
  console.log(JSON.stringify(createCompletion.data, null, 4));
